...
public class TestBusinessSubscriptionTransitionFactory extends AnalyticsTestSuiteNoDB {
    ...
    public void testRespectPrevPerService() throws Exception {
        ...
        Mockito.when(event2.getEffectiveDate()).thenReturn(new DateTime("2012-05-01"));
        ...
        Mockito.when(event12.getEffectiveDate()).thenReturn(new DateTime("2012-05-03"));
        ...
        Mockito.when(event22.getEffectiveDate()).thenReturn(new DateTime("2012-05-03"));
        ...
        Mockito.when(event3.getEffectiveDate()).thenReturn(new DateTime("2012-05-01"));
        ...
        Mockito.when(event4.getEffectiveDate()).thenReturn(new DateTime("2012-05-15"));
        ...
        Mockito.when(event5.getEffectiveDate()).thenReturn(new DateTime("2012-05-20"));
        ...
        Mockito.when(event32.getEffectiveDate()).thenReturn(new DateTime("2012-05-25"));
        ...
        Mockito.when(event42.getEffectiveDate()).thenReturn(new DateTime("2012-05-25"));
        ...
        Mockito.when(event6.getEffectiveDate()).thenReturn(new DateTime("2012-06-01"));
        ...
        Mockito.when(event7.getEffectiveDate()).thenReturn(new DateTime("2012-06-01"));
        ...
        Assert.assertEquals(result.get(0).getNextStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(0).getNextService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(0).getNextEndDate().compareTo(new DateTime("2012-05-15")), 0);
        ...
        Assert.assertEquals(result.get(1).getNextStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(1).getNextService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(1).getNextEndDate().compareTo(new DateTime("2012-05-15")), 0);
        ...
        Assert.assertEquals(result.get(2).getNextStartDate().compareTo(new DateTime("2012-05-03")), 0);
        Assert.assertEquals(result.get(2).getNextService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(2).getNextEndDate().compareTo(new DateTime("2012-05-25")), 0);
        ...
        Assert.assertEquals(result.get(3).getNextStartDate().compareTo(new DateTime("2012-05-03")), 0);
        Assert.assertEquals(result.get(3).getNextService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(3).getNextEndDate().compareTo(new DateTime("2012-05-25")), 0);
        ...
        Assert.assertEquals(result.get(4).getNextStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(4).getNextService(), "service-A");
        Assert.assertEquals(result.get(4).getNextEndDate().compareTo(new DateTime("2012-05-20")), 0);
        ...
        Assert.assertEquals(result.get(5).getPrevStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(5).getPrevService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(5).getNextStartDate().compareTo(new DateTime("2012-05-15")), 0);
        Assert.assertEquals(result.get(5).getNextService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(5).getNextEndDate().compareTo(new DateTime("2012-06-01")), 0);
        ...
        Assert.assertEquals(result.get(6).getPrevStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(6).getPrevService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(6).getNextStartDate().compareTo(new DateTime("2012-05-15")), 0);
        Assert.assertEquals(result.get(6).getNextService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(6).getNextEndDate().compareTo(new DateTime("2012-06-01")), 0);
        ...
        Assert.assertEquals(result.get(7).getPrevStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(7).getPrevService(), "service-A");
        Assert.assertEquals(result.get(7).getNextStartDate().compareTo(new DateTime("2012-05-20")), 0);
        ...
        Assert.assertEquals(result.get(8).getPrevStartDate().compareTo(new DateTime("2012-05-03")), 0);
        Assert.assertEquals(result.get(8).getPrevService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(8).getNextStartDate().compareTo(new DateTime("2012-05-25")), 0);
        ...
        Assert.assertEquals(result.get(9).getPrevStartDate().compareTo(new DateTime("2012-05-03")), 0);
        Assert.assertEquals(result.get(9).getPrevService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(9).getNextStartDate().compareTo(new DateTime("2012-05-25")), 0);
        ...
        Assert.assertEquals(result.get(10).getPrevStartDate().compareTo(new DateTime("2012-05-15")), 0);
        Assert.assertEquals(result.get(10).getPrevService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(10).getNextStartDate().compareTo(new DateTime("2012-06-01")), 0);
        ...
        Assert.assertEquals(result.get(11).getPrevStartDate().compareTo(new DateTime("2012-05-15")), 0);
        Assert.assertEquals(result.get(11).getPrevService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(11).getNextStartDate().compareTo(new DateTime("2012-06-01")), 0);
