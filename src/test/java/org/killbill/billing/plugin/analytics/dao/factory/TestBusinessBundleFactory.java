...
public class TestBusinessBundleFactory extends AnalyticsTestSuiteNoDB {
    ...
    public void testBundleStarted() throws AnalyticsRefreshException {
        ...
        Assert.assertEquals(bBundle.getCurrentStartDate().compareTo(new DateTime("2012-05-01")), 0);
    ...
    public void testBundleCancelled() throws AnalyticsRefreshException {
        ...
        Mockito.when(event4.getEffectiveDate()).thenReturn(new DateTime("2012-06-01"));
        ...
        Assert.assertEquals(result.get(0).getNextStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(0).getNextService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(0).getNextEndDate().compareTo(new DateTime("2012-06-01")), 0);
        ...
        Assert.assertEquals(result.get(1).getNextStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(1).getNextService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(1).getNextEndDate().compareTo(new DateTime("2012-06-01")), 0);

        Assert.assertEquals(result.get(2).getEvent(), "STOP_ENTITLEMENT_BASE");
        Assert.assertEquals(result.get(2).getPrevStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(2).getPrevService(), BusinessSubscriptionTransitionFactory.ENTITLEMENT_SERVICE_NAME);
        Assert.assertEquals(result.get(2).getNextStartDate().compareTo(new DateTime("2012-06-01")), 0);
        ...
        Assert.assertEquals(result.get(3).getPrevStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(result.get(3).getPrevService(), BusinessSubscriptionTransitionFactory.BILLING_SERVICE_NAME);
        Assert.assertEquals(result.get(3).getNextStartDate().compareTo(new DateTime("2012-06-01")), 0);
        ...
        final BusinessBundleModelDao bBundle = bundles.iterator().next();
        Assert.assertEquals(bBundle.getCurrentStartDate().compareTo(new DateTime("2012-05-01")), 0);
        Assert.assertEquals(bBundle.getCurrentEndDate().compareTo(new DateTime("2012-06-01")), 0);
    }
    ...
    public void testFilterBsts() throws Exception {
        ...
        final DateTime bundle1StartDate = new DateTime("2012-01-01");
        final DateTime bundle1PhaseDate = new DateTime("2012-02-02");
        final UUID bundleId2 = UUID.randomUUID();
        final UUID subscriptionId2 = UUID.randomUUID();
        final DateTime bundle2StartDate = new DateTime("2012-02-01");
        final DateTime bundle2PhaseDate = new DateTime("2012-03-02");
        final UUID bundleId3 = UUID.randomUUID();
        final UUID subscriptionId3 = UUID.randomUUID();
        final DateTime bundle3StartDate = new DateTime("2012-03-01");
        ...
        final Collection<BusinessSubscriptionTransitionModelDao> bsts = ImmutableList.<BusinessSubscriptionTransitionModelDao>of(
                ...
                createBst(UUID.randomUUID(), UUID.randomUUID(), "START_ENTITLEMENT_ADD_ON", new DateTime(DateTimeZone.UTC))
                                                                                                                                );
        ...
        Assert.assertEquals(filteredBsts.get(0).getNextStartDate().compareTo(bundle1PhaseDate), 0);
        Assert.assertEquals(filteredBsts.get(1).getBundleId(), bundleId2);
        Assert.assertEquals(filteredBsts.get(1).getNextStartDate().compareTo(bundle2PhaseDate), 0);
        Assert.assertEquals(filteredBsts.get(2).getBundleId(), bundleId3);
        Assert.assertEquals(filteredBsts.get(2).getNextStartDate().compareTo(bundle3StartDate), 0);
    }

    private BusinessSubscriptionTransitionModelDao createBst(final UUID bundleId, final UUID subscriptionId, final String eventString, final DateTime startDate) {
