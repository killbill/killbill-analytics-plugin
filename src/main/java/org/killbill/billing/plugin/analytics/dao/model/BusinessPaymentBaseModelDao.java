...
public abstract class BusinessPaymentBaseModelDao extends BusinessModelDaoBase {
    ...
    private BusinessPaymentBaseModelDao(final Account account,
        ...
        this(invoicePaymentRecordId,
             ...
             paymentTransaction.getPaymentInfoPlugin() != null ? paymentTransaction.getPaymentInfoPlugin().getGatewayError() : null,
             ...
             pluginPropertiesManager.getPluginProperty(1, paymentMethod, paymentTransaction),
             pluginPropertiesManager.getPluginProperty(2, paymentMethod, paymentTransaction),
             pluginPropertiesManager.getPluginProperty(3, paymentMethod, paymentTransaction),
             pluginPropertiesManager.getPluginProperty(4, paymentMethod, paymentTransaction),
             pluginPropertiesManager.getPluginProperty(5, paymentMethod, paymentTransaction),
