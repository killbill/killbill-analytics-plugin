...
public abstract class BusinessInvoicePaymentBaseModelDao extends BusinessModelDaoBase {
    ...
    protected BusinessInvoicePaymentBaseModelDao(final Account account,
        ...
        this(invoicePaymentRecordId,
             ...
             refund != null ? (refund.getRefundInfoPlugin() != null ? refund.getRefundInfoPlugin().getCreatedDate() : null) : (payment.getPaymentInfoPlugin() != null ? payment.getPaymentInfoPlugin().getCreatedDate() : null),
             refund != null ? (refund.getRefundInfoPlugin() != null ? refund.getRefundInfoPlugin().getEffectiveDate() : null) : (payment.getPaymentInfoPlugin() != null ? payment.getPaymentInfoPlugin().getEffectiveDate() : null),
             refund != null ? (refund.getRefundInfoPlugin() != null && refund.getRefundInfoPlugin().getStatus() != null ? refund.getRefundInfoPlugin().getStatus().toString() : null) : (payment.getPaymentInfoPlugin() != null && payment.getPaymentInfoPlugin().getStatus() != null ? payment.getPaymentInfoPlugin().getStatus().toString() : null),
             refund != null ? (refund.getRefundInfoPlugin() != null ? refund.getRefundInfoPlugin().getGatewayError() : null) : (payment.getPaymentInfoPlugin() != null ? payment.getPaymentInfoPlugin().getGatewayError() : null),
             refund != null ? (refund.getRefundInfoPlugin() != null ? refund.getRefundInfoPlugin().getGatewayErrorCode() : null) : (payment.getPaymentInfoPlugin() != null ? payment.getPaymentInfoPlugin().getGatewayErrorCode() : null),
             refund != null ? (refund.getRefundInfoPlugin() != null ? refund.getRefundInfoPlugin().getFirstRefundReferenceId() : null) : (payment.getPaymentInfoPlugin() != null ? payment.getPaymentInfoPlugin().getFirstPaymentReferenceId() : null),
             refund != null ? (refund.getRefundInfoPlugin() != null ? refund.getRefundInfoPlugin().getSecondRefundReferenceId() : null) : (payment.getPaymentInfoPlugin() != null ? payment.getPaymentInfoPlugin().getSecondPaymentReferenceId() : null),
             ...
             paymentMethod != null ? (paymentMethod.getPluginDetail() != null ? paymentMethod.getPluginDetail().getCCExpirationMonth() : null) : null,
             paymentMethod != null ? (paymentMethod.getPluginDetail() != null ? paymentMethod.getPluginDetail().getCCExpirationYear() : null) : null,
