...
LEFT OUTER JOIN v_report_payment_provider_conversion_sub1 rpccs1 ON rpccs1.plugin_name=rpccs2.plugin_name AND rpccs1.tenant_record_id=rpccs2.tenant_record_id
GROUP BY
  plugin_name
, tenant_record_id
;
