...
public class BusinessPaymentCreditModelDao extends BusinessPaymentBaseModelDao {

    public BusinessPaymentCreditModelDao() { /* When reading from the database */ }

    public BusinessPaymentCreditModelDao(final Account account,
